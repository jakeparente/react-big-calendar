...
var TimeGutter = function TimeGutter(_ref2) {
  ...
  var renderSlot = useCallback(function (value, idx) {
    ...
    var formattedTime = localizer.format(value, 'timeGutterFormat');
    // Split formatted time into hour and am/pm
    var match = formattedTime.match(/^(\d+)(am|pm)$/i);
    var hour = match ? match[1] : formattedTime;
    var period = match ? match[2] : '';
    return /*#__PURE__*/React.createElement("span", {
      className: clsx('rbc-label', isNow && 'rbc-now')
    }, /*#__PURE__*/React.createElement("span", {
      className: "rbc-timeslot-hour"
    }, hour), /*#__PURE__*/React.createElement("span", {
      className: "rbc-timeslot-period"
    }, period));
